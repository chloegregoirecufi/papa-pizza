...
<main class="container-form">
    <h1 class="title">Bienvenue dans la personnalisation de votre pizza</h1>
    ...
    <form class="auth-form" action="/user/add-pizza-form" method="POST" enctype="multipart/form-data">
